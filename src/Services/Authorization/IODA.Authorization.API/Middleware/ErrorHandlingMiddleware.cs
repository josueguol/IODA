...
namespace IODA.Authorization.API.Middleware;
...
public class ErrorHandlingMiddleware
{
    ...
    private async Task HandleExceptionAsync(HttpContext context, Exception exception)
    {
        var (statusCode, problemDetails) = exception switch
        {
            ...
            RoleNotFoundException => ((HttpStatusCode)HttpStatusCode.NotFound, CreateProblem(404, "Not Found", exception.Message)),
            PermissionNotFoundException => ((HttpStatusCode)HttpStatusCode.NotFound, CreateProblem(404, "Not Found", exception.Message)),
            AccessRuleNotFoundException => ((HttpStatusCode)HttpStatusCode.NotFound, CreateProblem(404, "Not Found", exception.Message)),
            DomainException domainEx => ((HttpStatusCode)HttpStatusCode.BadRequest, CreateProblem(400, "Bad Request", domainEx.Message)),
            InvalidOperationException opEx => ((HttpStatusCode)HttpStatusCode.Conflict, CreateProblem(409, "Conflict", opEx.Message)),
